...
const TimeTableRegister = () => {
 ...
 const handleTimeChange = (e) => {
    ...
    setTimeTableReqDto({...movieTimeTableReqDto, [e.target.name]:e.target.value});
 }
  ...
  return (
    <>
      ...
      <div style={{ width: "1200px", marginLeft: "50px" }}>
        <form
          method="POST"
          action="http://localhost:8080/timetable"
        >  
          <Table striped bordered hover>
            ...
            <tbody id="theater_tbody">
              <tr>
                ...
                <td>
                  <input type="time" name="startTime" min="09:00" onChange={handleTimeChange} required/>
                </td>
                <td>
                <DatePicker
                  name = "date" 
                ...
                <td>
                  <select onChange={handleTheaterChange} name="theaterId" required>
                  <option value="" selected disabled hidden>Choose here</option>
